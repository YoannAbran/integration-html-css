...
<head>
  ...
  <title>presentation html css</title>
...
<body>
  ...
  <a class="navbar-brand" target="_blank" href=https://www.accesscodeschool.fr/"><img id="logo-acs" src="img/logo-acs-black.png" alt="logo access code school"></a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="bootstrap.php">Boostrap</a>
      </li>
    </ul>
  </div>
</nav>
